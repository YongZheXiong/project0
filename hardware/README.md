...
7. `wiring/p2_stm32_power_fault_summary_2026-06-17.md`
   - STM32 控制板 3.3V 供电故障、隔离边界、替换板验收顺序和后续基础验证结果。
...
急停动力切断、STM32 替换板、UART 和四路编码器低功率手动计数已完成基础验证，但线束最终固定、正式控制协议、停车策略、长期温升、悬空动力和落地运动仍未闭环。原 STM32 控制板当前处于 3.3V 供电故障隔离状态。
